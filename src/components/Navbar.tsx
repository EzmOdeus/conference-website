      ...
      <div className="container mx-auto px-4 py-3">
        <nav className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-1">
            ...
            <a href="#patrons" className="nav-link">
              الرعاة
            </a>
            ...
            <a href="#registration" className="nav-link  text-purple-900 ">
              {" "}
              <img
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-indigo-950/95 backdrop-blur-md">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-3">
            ...
            <a href="#patrons" className="nav-link" onClick={toggleMenu}>
              الرعاة
            </a>
            <a href="#topics" className="nav-link" onClick={toggleMenu}>
              المحاور
            </a>
            ...
            <a
              href="#registration"
              className="nav-link bg-yellow-500 text-purple-900 w-full text-center"
              onClick={toggleMenu}
            >
              التسجيل
            </a>
